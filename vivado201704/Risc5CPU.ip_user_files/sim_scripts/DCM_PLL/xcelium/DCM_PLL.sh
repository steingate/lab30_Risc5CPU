...
#
# Script generated by Vivado on Mon Nov 18 08:30:32 +0800 2024
...
#
# Usage        : DCM_PLL.sh
#                DCM_PLL.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DCM_PLL.sh [-reset_run]
#                DCM_PLL.sh [-reset_log]
#                DCM_PLL.sh [-help]
#
...
#                script (type 'DCM_PLL.sh -help' for more information).
#
...
# script info
echo -e "DCM_PLL.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DCM_PLL.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DCM_PLL xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DCM_PLL -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DCM_PLL_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: DCM_PLL.sh [-step]\n\
Usage: DCM_PLL.sh [-lib_map_path]\n\
Usage: DCM_PLL.sh [-reset_run]\n\
Usage: DCM_PLL.sh [-reset_log]\n\
Usage: DCM_PLL.sh [-keep_index]\n\
